    ...
    try {
      ...
      switch(choice) {
        ...
        case 3:
          ...
          break;
        case 4:
            System.out.println("Choose concat, enter first string:");
            ...
            break;
        case 5:
            System.out.println("Choose names, enter name you want to send or press enter to just see all names");
      ...
      if (res.getBoolean("ok")){
        ...
        } else if(res.getString("type").equals("concat")) {
            System.out.println(res.getString("result"));
        }
        else if( res.getString("type").equals("names")) {
            if(res.has("result")) {
                System.out.println(res.getString("result"));
                System.out.println(res.getString("allNames"));
            }
            else{
                System.out.println(res.getString("allNames"));
            }
